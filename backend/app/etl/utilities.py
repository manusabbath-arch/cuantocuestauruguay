...
class UtilitiesETL:
    ...
    def _get_sample_antel_data(self) -> List[Dict]:
        ...
        return [
            ...
            {
                'producto': 'ANTEL_FIBRA_200',
                'fecha': today,
                'valor': 1290.00,
                'fuente': 'Antel - Datos de ejemplo'
            },
            {
                'producto': 'ANTEL_FIBRA_500',
                'fecha': today,
                'valor': 1590.00,
                'fuente': 'Antel - Datos de ejemplo'
            }
    ...
    async def run_all(self) -> Dict[str, any]:
        ...
        results = {
            "ute": await self.run_ute(),
            "ose": await self.run_ose(),
            "antel": await self.run_antel()
        }
        
        total_loaded = sum(
            r.get('records_loaded', 0) 
